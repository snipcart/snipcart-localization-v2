...
"Счет будет выставлен вам по email.",
...
"Пожалуйста введите свой email, на который прийдет ссылка для восстановления пароля.",
forgot_password_success_email_sent:
"Email выслан",
forgot_password_email_sent_message:
"На ваш email выслана инструкция для восстановления. Пожалуйста проверьте свой email и следуйте указанным в нем инструкциям.",
...
"Используйте этот адрес для доставки",
...
"Карта истекает  месяц / год",
payment_method_card_exp_year:
"Карта истекает год",
payment_method_cvc_infos:
"CVC это 3 цифры номера безопасности, сзади на вашей кредитной карте как правило в правой части вашей подписи.",
create_an_account:
"Создать аккаунт",
why_create_account:
"Для более быстрого оформления заказа в следующий раз просто ввести пароль чтобы создать логин.",
reset_password:
"Сброс пароля",
...
"Ваша учетная запись была успешно создана спасибо.",
errors_required:
...
"Талон на спроса пароля истек.",
errors_invalid_authentication_infos:
"Неверные сведения аутентификации",
error_payment_items_empty:
"Кажется что ваш заказ является недействительным пожалуйста перезагрузите страницу.  Ваша кредитная карта не была заряжена.",
error_payment_items_are_invalid:
"Мы не были в состоянии выполнить ваш заказ.  Кажется что один из пунктов в вашей корзине имеет недопустимую цену.",
error_crawling_failed:
"Мы не смогли подтвердить ваш заказ, средства с вашей кредитной карты не взимаются, пожалуйста повторите попытку через несколько минут.",
powered_by:
...
"Информация о заказе",
generic_error_title:
"Опля, К сожалению произошла ошибка.",
...
"Корзина для этого сайта была отключена.  Если вы владелец этого веб-сайта пожалуйста войдите в Snipcart приборной панели чтобы решить эту проблему.",
payment_require_title:
"Корзина отключена.",
configuration_problem:
"проблемы настройки",
additionnal_information:
"Введите сообщение ниже если вы хотите чтобы отправить отзыв или более подробную информацию об этой проблеме.",
send_error:
"Отправить эту ошибку владельцу сайта",
message_sent:
"Сообщение отправлено спасибо",
paypalexpress_loading:
"Вы будете перенаправлены на Paypal чтобы произвести оплату в ближайшее время.",
...
"Что-то пошло не так при проверке ваш заказ не волнуйтесь вы не были предъявлены обвинения.  Этот веб-сайт в настоящее время в тестовом режиме.",
order_completedon:
"Разместить",
...
"История счетов",
item_out_of_stock:
"К сожалению этот товар сейчас нет в наличии.",
...
"Ваша подписка была отменена успешно.",
...
"Нажмите на эту кнопку если вы предпочитаете чтобы обработать ваш платеж непосредственно через PayPal.",
notifications_item_not_added_due_to_max_quantity:
"Продукт не был добавлен у вас уже есть максимальное количество в вашей корзине.",
error_impossible_to_calculate_taxes:
"Мы не смогли рассчитать налоги для заказа это может быть связано с неправильным адресом пожалуйста убедитесь что вы ввели правильный адрес с 5 цифр ПОЧТОВЫЙ ИНДЕКС."
});
